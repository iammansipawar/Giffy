...
import com.example.giffy.adapters.PlaceYourOrderAdapter;
...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    public void onCreate( Bundle savedInstanceState) {
        ...
        buttonPlaceYourOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onPlaceOrderButtonClick(categoryModel);
            }
        });
    ...
    private void calculateTotalAmount(CategoryModel categoryModel) {
        ...
        for(Menu m : categoryModel.getMenus()) {
            subTotalAmount += m.getPrice() * m.getTotalInCart();
        }

        tvSubtotalAmount.setText("Rs "+String.format("%.2f", subTotalAmount));
        if(isDeliveryOn) {
            tvDeliveryChargeAmount.setText("Rs "+String.format("%.2f", categoryModel.getDelivery_charge()));
            subTotalAmount += categoryModel.getDelivery_charge();
        }
        tvTotalAmount.setText("Rs "+String.format("%.2f", subTotalAmount));
    }

    private void onPlaceOrderButtonClick(CategoryModel categoryModel) {
    ...
    private void initRecyclerView(CategoryModel categoryModel) {
        ...
        placeYourOrderAdapter = new PlaceYourOrderAdapter(categoryModel.getMenus());
